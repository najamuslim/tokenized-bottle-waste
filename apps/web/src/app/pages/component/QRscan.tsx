      ...
      <div id="contentScan">
        ...
        {BottleSubmitSussess ? (
          <div className="qr-reader">
            {/* QR Scanner */}
            <video ref={videoEl} className={isBottleSubmit ? "bottle-submit" : "wait-submit"}></video>
            {isBottleSubmit ? (
              <span id="p-bars">
                <CircularProgress percentage={progress} size={120} color="#F5CC00" />
              ...
              <div ref={qrBoxEl} className="qr-box">
                <Image src={QrFrame} alt="QR Frame" width={300} height={300} className="qr-frame" />
              </div>
            )}
          </div>
        ) : (
